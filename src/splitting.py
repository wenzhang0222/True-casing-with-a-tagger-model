...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-i", "--input_path", required=True, help="path to input data"
    )
    parser.add_argument(
        "-t", "--train_path", required=True, help="path to output training data"
    )
    parser.add_argument(
        "-d", "--dev_path", required=True, help="path to output development data"
    )
    parser.add_argument(
        "-T", "--test_path", required=True, help="path to output test data"
    )
